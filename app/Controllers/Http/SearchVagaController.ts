...
class SearchVagaController {
  async index () {
    const vaga = await Database.select('vagases.title', 'vagases.cidade_id', 'vagases.empresa_id', 'vagases.id',
      ...
      'cidades.state_id', 'estados.letter as uf', 'periodo_trabalhos.title as periodoTrabalho')
      .table('vagases')
  ...
  async show ({ params }) {
    const vaga = await Database.select('vagases.title', 'vagases.cidade_id', 'vagases.empresa_id', 'vagases.id',
      ...
      'escolaridades.title as escolaridade', 'vagases.valor_comissao', 'vagases.beneficios', 'periodo_trabalhos.title as periodoTrabalho',
